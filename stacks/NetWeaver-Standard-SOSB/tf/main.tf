...
module "gcp_hana" {
  source                = "../../../terraform/modules/hana-scaleout-standby"
  ...
  instance_count_worker  = var.sap_hana_instance_count_worker
  instance_count_standby = var.sap_hana_instance_count_standby
}
