...
`sap_nw_nfs_src`: (Conditional, type _string_) - An NFS mount to be used for shared storage, for example `10.2.3.4:/sap`. This must be defined if `sap_filestore_name` is not defined.
