...
###################     Call install-javachrome.ps1      ###################
$InstallerPs1 = "install-javachrome.ps1"
gsutil cp  $GSBucket/$InstallerPs1 $Path\$InstallerPs1                       ### Copy install-javachrome.ps1
& $Path\$InstallerPs1|Out-Null                                               ### Wait till the ps1 execution is complete.
