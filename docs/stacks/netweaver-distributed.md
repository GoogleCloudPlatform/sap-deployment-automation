...
| Name | Description | Type | Default | Required |
|------|-------------|------|---------|:--------:|
| `sap_ascs_instance_name` | Name of the ASCS instance. | `string` | n/a | yes |
| `sap_pas_instance_name` | Base name of application server instances. | `string` | n/a | yes |
| `sap_hana_instance_name` | Name of the HANA instance. | `string` | n/a | yes |
...
| `sap_hana_subnetwork` | The name of the subnetwork used for the HANA machine. | `string` | n/a | yes |
